...
def show_page():
    ...
    # 1. Menyiapkan Data Performa (Gabungan data kamu & Fatih)
    # Masukkan angka akurasi Fatih di bagian Decision Tree jika sudah ada
    data = {
        'Model': ['Random Forest (Ihsan)', 'Decision Tree (Fatih)'],
        'R² Score (Akurasi)': [0.4704, 0.3520],  # 47.04% vs Contoh data Fatih 35.20%
        'MAE (Rata-rata Eror)': [4.26, 5.15]     # 4.26 vs Contoh data Fatih 5.15
    }
